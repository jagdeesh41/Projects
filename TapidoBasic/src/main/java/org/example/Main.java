...
public class Main
{
    ...
    public static void add_driver(String  driver_details,String vehicle_details,Pair current_location)
    {
...
//        });
          ...
          add_driver("Driver1, M, 22","Swift, KA-01-12345",new Pair(10,1));
          add_driver("Driver2, M, 29","Swift, KA-02-12345",new Pair(11,10));
          add_driver("Driver3, M, 22","Swift, KA-03-12345",new Pair(5,3));
